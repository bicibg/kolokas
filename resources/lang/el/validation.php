...
return [
    ...
    'attributes' => [
        ...
        'total_images_with_existing' => 'Μπορείτε να έχετε έως 5 επιπλέον εικόνες. Φροντίστε να αποεπιλέξετε τα παλιά αν θέλετε να τα αντικαταστήσετε. "',
        'nohtml' => 'Δεν επιτρέπεται η είσοδος με ετικέτες HTML.'
    ],
