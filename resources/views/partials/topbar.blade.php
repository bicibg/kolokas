<nav class="navbar topbar navbar-expand navbar-light bg-light no-print d-none d-md-block py-0 px-4">
    <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav m-0 p-0">
            <li class="nav-item"><a href="https://www.facebook.com/kolokas-recipes"><i class="fa fa-facebook"></i></a></li>
            <li class="nav-item"><a href="https://www.twitter.com/kolokas-recipes"><i class="fa fa-twitter"></i></a></li>
            <li class="nav-item"><a href="https://www.pinterest.com/kolokas-recipes"><i class="fa fa-pinterest"></i></a></li>
            <li class="nav-item"><a href="https://www.instagram.com/kolokas-recipes"><i class="fa fa-instagram"></i></a></li>
        </ul>
