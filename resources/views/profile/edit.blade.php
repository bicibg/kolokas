                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <input class="form-control input-lg" name="current_password" type="password"
                                               id="current_password">
                                        <small id="titleHelp" class="footnote form-text text-muted font-italic">Your current password</small>
                                    </div>
                                    <div class="form-group col-md-4 col-sm-12">
                                        <label for="new_password">New Password *</label>
                                        <input class="form-control input-lg" name="new_password" type="password"
                                               id="new_password">
                                        <small id="titleHelp" class="footnote form-text text-muted font-italic">Your new password</small>
                                    </div>
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <small id="titleHelp" class="footnote form-text text-muted font-italic">Repeat your new password</small>
                                    </div>
