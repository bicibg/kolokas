                        ...
                        <fieldset>
                            ...
                            <div class="form-row mb-2 mt-5">
                                <div class="offset-md-2 col-md-10 border-top">
                                    <div class="muted">
                                        <p><span class="rd_tg_bold">NOTE:</span> Photos may be used in print
                                            publications or
                                            on
                                            the
                                            website. Please submit a high resolution jpg image at 300dpi. Uploaded files
                                            are
                                            limited to
                                        ...
                                        <p>By submitting material for publication, you grant {{ env('APP_CLEAN_URL') }}
                                            ...
                                            reproduce
                                            and
                                            distribute the material in any medium and in any manner. We may contact you
                                            via
                                            phone, email
